...
app.get('/', (req, res) => {
    res.json({
        name: 'Anime-Sama API',
        version: '2.0.0',
        description: 'Real-time anime scraping API for anime-sama.org',
        author: 'el_cid',
        poweredBy: 'el_cid',
        status: 'running',
        endpoints: {
            ...
            embed: '/api/embed?url=https%3A%2F%2Fanime-sama.org%2Fcatalogue%2F...'
        },
        examples: {
            ...
            embedPlayer: 'GET /api/embed?url=https%3A%2F%2Fanime-sama.org%2Fcatalogue%2Fblack-butler'
        }
    });
});
...
if (require.main === module) {
    app.listen(PORT, '0.0.0.0', () => {
        ...
        console.log('🎬 Embed endpoint:', `http://localhost:${PORT}/api/embed?url=https%3A%2F%2Fanime-sama.org%2Fcatalogue%2Fblack-butler`);
    });
}
